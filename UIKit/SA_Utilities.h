...
#define		$S(format, ...)				[NSString stringWithFormat: format, ##  __VA_ARGS__, nil]
#define		$U(format, ...)				[NSURL URLWithString: [NSString stringWithFormat: format, ##  __VA_ARGS__, nil]]
#define		$P(format, ...)				[NSPredicate predicateWithFormat: format, ##  __VA_ARGS__, nil]
